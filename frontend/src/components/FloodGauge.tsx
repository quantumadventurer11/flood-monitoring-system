export default function FloodGauge({ probability }: { probability: number }) {
  ...
  return (
    <div className="card p-4 text-center">
      <div className="mx-auto grid h-36 w-36 place-items-center rounded-full" style={{ background: `conic-gradient(${color} ${pct}%, #e2e8f0 0)` }}>
      ...
      <p className="mt-3 text-sm text-slate-600">Flood probability</p>
    </div>
  );
}
